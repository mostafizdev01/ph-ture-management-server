...
const loadEnvVariables = (): EnvConfig => {
    const requiredEnvVariables : string[] = ["PORT", "DB_URL", "NODE_ENV", "JWT_ACCESS_TOKEN", "JWT_ACCESS_EXPIRES", "BCRYPT_SALT_ROUND", "SUPER_ADMIN_EMAIL", "SUPER_ADMIN_PASS", "JWT_REFRESH_TOKEN", "JWT_REFRESH_EXPIRES"]
